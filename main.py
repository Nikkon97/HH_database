...
def main():
    ...
    company_name = input("Введите слово, которое хотели бы видеть в названиях компаний: \n")
    get_data_employers_hh(company_name)
    ...
    keyword = input("Введите слово, которое хотели бы видеть в названии вакансии: \n")
    data_5 = db_manager_1.get_vacancies_with_keyword(keyword)
